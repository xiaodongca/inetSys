...
.content{
  ...
  <body>
  		<br/>
  		<br/>
        &nbsp;&nbsp;<a href="${pageContext.servletContext.contextPath}/activity/toForm">增加活动</a>
  		<br/>
  		<br/>
		...
		<c:forEach items="${activityList}" var="activity">
			<tr>
				...
				<td>${activity.admin_name }</td>
			 	<td><a href="${pageContext.servletContext.contextPath}/activity/toForm?Id=${activity.a_id}">修改</a>
					/
					<a href="${pageContext.servletContext.contextPath}/activity/delete?Id=${activity.a_id}">删除</a>
				</td>
			</tr>
		</c:forEach>
	</table>
